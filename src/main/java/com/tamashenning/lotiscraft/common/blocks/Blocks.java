...
import com.tamashenning.lotiscraft.common.blocks.sample.BlockSample;
import com.tamashenning.lotiscraft.common.blocks.washers.BlockIronWasher;
...
public enum Blocks {
    ...
    IRON_WASHER(BlockIronWasher.class)
    ;
